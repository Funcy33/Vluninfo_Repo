...
This vulnerability lies in the `/goform/addressNat` page which influences the lastest version of Tenda Router AC500. (The latest version is [AC500_V1.0.0.16](https://www.tenda.com.cn/download/detail-2219.html))
